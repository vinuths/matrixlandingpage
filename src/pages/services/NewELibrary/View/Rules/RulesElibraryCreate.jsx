...
const RulesElibraryCreate = ({ addOrEdit, recordForEdit, setLocalPage }) => {
    ...
    const handleSubmit = async (e) => {
        ...
        if (recordForEdit?._id) {
            dispatch(ruleLibraryUpdate(formData, recordForEdit._id));
            addOrEdit();
        } else {
            dispatch(ruleLibraryCreate(formData));
        }
                ...
                <div className="container">
                    <form className="row g-3" onSubmit={handleSubmit} encType="multipart/form-data">
                        ...
                        <div className="col-12 mb-2">
                            <label className="form-label">Rule or Rule *</label>
                            <input
                                type="text"
                                id="rule"
                                name="rule"
                                className="form-control"
                                placeholder="Enter Rule or Rule"
                                value={rule}
...
export default RulesElibraryCreate;
