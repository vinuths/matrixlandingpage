...
function CompCatView() {
  ...
  const calling = () => {
    setTimeout(() => {
      dispatch(complianceCategoryPaginatedGet(1, 20));
      dispatch(stateGets());
                ...
                <div class="tab-pane fade show active" id="pills-home" role="tabpanel" aria-labelledby="pills-home-tab">
                  <div class="row">
                    <div class="col-12 col-lg-12">
                      <CompCatTable localPage={localPage} setLocalPage={setLocalPage} />
                    </div>
                  </div>
                </div>
                <div class="tab-pane fade" id="pills-profile" role="tabpanel" aria-labelledby="pills-profile-tab">
                  <CompCatCreate setLocalPage={setLocalPage} />
                </div>
