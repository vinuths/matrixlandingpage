...
import { stateGets, reLeagalUpdateLibraryCreate, reLeagalUpdateLibraryUpdate } from '../../../../store/actions/otherActions';

const LegalUpdsCreate = ({ addOrEdit, recordForEdit, setLocalPage }) => {
    ...
    useEffect(() => {
        if (recordForEdit) {
            ...
            setDepartment(recordForEdit.department || '');
    ...
    const handleSubmit = async (e) => {
        ...
        if (recordForEdit?._id) {
            dispatch(reLeagalUpdateLibraryUpdate(formData, recordForEdit._id));
            addOrEdit();
        } else {
            dispatch(reLeagalUpdateLibraryCreate(formData));
        }
                    ...
                    <form className="row g-3" onSubmit={handleSubmit} encType="multipart/form-data">
                        {!recordForEdit ? (
                            <h2 style={{ color: '#013879', fontWeight: '700', textAlign: 'center', marginBottom: '40px' }}>
                                Create New Legal Update E-Library
                            </h2>
                        ) : (
                            <h2 style={{ color: '#013879', fontWeight: '700', textAlign: 'center', marginBottom: '40px' }}>
                                Edit Legal Update E-Library
                            </h2>
                        )}
...
export default LegalUpdsCreate;
